    ...
    <div className='pb-20 pt-26'>
      ...
      <div className="flex h-screen w-full items-center justify-center bg-white dark:bg-black-100 absolute top-0 left-0 ">
        <div
          className={cn(
            ...
            "dark:[background-image:linear-gradient(to_right,#262626_0.03px,transparent_0.85px),linear-gradient(to_bottom,#262626_0.03px,transparent_0.85px)]",
          )}
        />
      ...
      <div className='flex justify-center relative my-20 z-10 '>
        ...
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
          ...
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">Hi, I'm Leandro a Next.js Developer based in Brazil.</p>
          <a href="#about">
            <MagicButton
              title="Show my work"
